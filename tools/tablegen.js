            ...
            case 'def': {
                ...
                if (defName.includes('.')) {
                    ...
                    if (typeof baseValue === 'string') {
                        const def = this.parser.defs.get(baseValue) || this.parser.classes.get(baseValue);
                        if (def) {
                            ...
                            for (const fieldName of fieldPath) {
                                ...
                                if (typeof evaluated === 'string' && (this.parser.defs.get(evaluated) || this.parser.classes.get(evaluated))) {
                                    current = this.parser.defs.get(evaluated) || this.parser.classes.get(evaluated);
                                } else {
                                    return evaluated;
                                }
                            }
